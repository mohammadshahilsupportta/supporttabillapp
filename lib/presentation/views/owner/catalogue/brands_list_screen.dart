...
class _BrandsListScreenState extends State<BrandsListScreen> {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => pc.loadBrands(),
          ),
        ],
      ),
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => _showCreateBrandDialog(context, pc),
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Search brands by name, code, or description...',
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            ...
                            child: InkWell(
                              borderRadius: BorderRadius.circular(12),
                              onTap: () =>
                                  _showEditBrandDialog(context, pc, brand),
                              child: Padding(
                                padding: const EdgeInsets.all(16),
                                child: Column(
  ...
  void _showCreateBrandDialog(BuildContext context, ProductController pc) {
  ...
  void _showEditBrandDialog(BuildContext context, ProductController pc, brand) {
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                if (formKey.currentState!.validate()) {
                  Navigator.pop(context);
                  final success = await pc.updateBrand(brand.id, {
  ...
  void _showDeleteDialog(BuildContext context, ProductController pc, brand) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              Navigator.pop(context);
              final success = await pc.deleteBrand(brand.id);
              if (success) {
                // Snackbar is handled in controller
              }
            },
